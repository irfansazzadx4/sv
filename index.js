...
<body style="text-align: center;">
    <div class="printable-container">
        ...
        <div style="position: absolute; left: 37%; top: 78.3%; width: 48%; font-size: 14.3px; text-align: left; white-space: normal;">${presentAddr}</div>

        <div style="position: absolute; left: 37%; top: 84.4%; font-size: 17px;"><b>স্থায়ী ঠিকানা</b></div>
        <div style="position: absolute; left: 37%; top: 87.3%; width: 48%; font-size: 14.3px; text-align: left; white-space: normal;">${permanentAddr}</div>
